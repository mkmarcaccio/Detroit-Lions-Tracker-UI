...
@Component({
  selector: 'app-previous-players-add-edit-dialog',
  templateUrl: './previous-players-add-edit-dialog.component.html',
  styleUrls: ['./previous-players-add-edit-dialog.component.scss']
})
export class PreviousPlayersAddEditDialogComponent implements OnInit {
